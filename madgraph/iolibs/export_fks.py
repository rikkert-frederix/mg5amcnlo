...
"""
    ...
    def write_spin_density_born(self, writer, fksborn, fortran_model,
        ...
        core.extend([
            ...
            'DOUBLE PRECISION SDM_CACHED_P(0:3,NEXTERNAL-1)',
            'DOUBLE PRECISION SDM_CACHED_AMP2(NGRAPHS)',
            'DOUBLE PRECISION SDM_CACHED_G,SDM_CACHED_MUR2,',
            '     $ SDM_CACHED_QES2',
            'LOGICAL SDM_CACHE_VALID,SDM_CACHE_HIT',
            'SAVE SDM_CACHE_VALID,SDM_CACHED_P,SDM_CACHED_AMP2,',
            ...
            'ENDIF',
            'IF (SDM_CACHE_HIT) THEN',
            '  AMP2B=SDM_CACHED_AMP2',
            'ELSE',
            '  CALL SDM_BORN_CHANNEL_WEIGHTS(P,AMP2B)',
            '  SDM_CACHED_P=P',
            '  SDM_CACHED_AMP2=AMP2B',
            '  SDM_CACHED_G=STRONG_COUPLING',
            '  SDM_CACHED_MUR2=MUR2_CURRENT',
            '  SDM_CACHED_QES2=QES2_CURRENT',
            '  SDM_CACHE_VALID=.TRUE.',
